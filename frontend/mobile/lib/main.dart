  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      routes: {
        ...
        '/user_dashboard/home': (context) => const HomePage(),
        '/soil_analysis/detection_capteurs': (context) => const DetectionCapteursPage(),
        '/soil_analysis/analysis': (context) => const AnalysisScreen(),
        '/soil_analysis/crop_detail': (context) => const CropDetailScreen(),
      },
    );
  }
}
